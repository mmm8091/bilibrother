...
const PredictionPage = () => {
  ...
  return (
    <div className="page-container">
      ...
      {prediction && (
        <Card title="预测结果" className="card-container">
          <Row gutter={[24, 24]}>
            ...
            <Col xs={24} sm={24} md={8}>
              <Card>
                ...
                />
                <Divider />
                <Text type="secondary">预估范围: {prediction.range_score || '未提供'}</Text>
              </Card>
            </Col>

            <Col xs={24} sm={24} md={8}>
              <Card>
                <Title level={4}>趋势评分</Title>
                <Space direction="vertical" style={{ width: '100%' }}>
                  <Row align="middle">
                    <Col span={12}><Text><FireOutlined /> 热度评分:</Text></Col>
                    <Col span={12}>
                  ...
                  <Row align="middle">
                    <Col span={12}><Text><HeartOutlined /> 情感评分:</Text></Col>
                    <Col span={12}>
                  ...
                  <Row align="middle">
                    <Col span={12}><Text><PlayCircleOutlined /> 视觉评分:</Text></Col>
                    <Col span={12}>
                  ...
                  <Row align="middle">
                    <Col span={12}><Text><TrophyOutlined /> 创意评分:</Text></Col>
                    <Col span={12}>
